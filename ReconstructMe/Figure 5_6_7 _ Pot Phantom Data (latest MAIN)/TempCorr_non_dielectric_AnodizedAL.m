function [Tc]= TempCorr_non_dielectric_AnodizedAL(viewing_angle,Tm,Ta)
% non-dieletric directional emissivity simulation for Anodized AL ( using the parameter of
