...
% Using the steady state image as the tracking template
[ImRt]= Read_IR_raw_data('090557',1);
[ImTt]= TempConvert(ImRt);
It= mat2gray(ImTt);
...
subplot(2,2,3);
imshow(It(TempPos_t(1,1):TempPos_t(1,2),TempPos_t(2,1):TempPos_t(2,2)));
...
center=[TempPos_t(1,1)+TempPos_t(1,2)-1 TempPos_t(2,1)+TempPos_t(2,2)-1]/2;
TemplateData(1).p=[0 0 0 0 center(1) center(2)];
TemplateData(1).weight=mat2gray(It(TempPos_t(1,1):TempPos_t(1,2),TempPos_t(2,1):TempPos_t(2,2)));
TemplateData(1).image=It(TempPos_t(1,1):TempPos_t(1,2),TempPos_t(2,1):TempPos_t(2,2));
