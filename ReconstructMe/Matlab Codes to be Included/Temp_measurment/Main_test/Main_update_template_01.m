...
% Set the temperature elevation scale resolution for color mapping
...
for i= initial:final
    ...
    % Update the new tempelate image
...
% Show the movie frame
    if(i==initial), figure, handle_imshow=imagesc(ROI_temp_i, [12 35]);
...
figure;
plot(0:2:(final-initial+1)*2-1,Temp_rec_l(:,1)./l_max,'b*'); 
hold on;
grid on;
