...
[l_p,h_p,Lesion_B_IR_mapped,CIR_mapped,point_num]=lesion_points_mapping_auto(Lesion_B_W,ImT1);
% load('l_p.mat');
% load('h_p.mat');
...
for i= initial:final
    ...
    for t=1:length(TemplateData)
        % stor template center to compute the translation
        center=TemplateData(1).p(5:6);
        ...
        TempShift= TemplateData(1).p(5:6)- center;
        TempPos1=TempPos1 + [TempShift;TempShift];
        TemplateData(1).weight=mat2gray(I(TempPos1(1,1):TempPos1(1,2),TempPos1(2,1):TempPos1(2,2)));
        TemplateData(1).image=I(TempPos1(1,1):TempPos1(1,2),TempPos1(2,1):TempPos1(2,2));
    end
