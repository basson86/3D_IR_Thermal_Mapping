function[l_p,h_p,Lesion_B_IR_mapped,CIR_mapped,point_num]=lesion_points_mapping_manual(Lesion_B_W,imR_ir,CW,CIR,lowT,highT)
...
l_centroid= ginput(1);
% get the probe region of lesion by selecting the 3x3 pixels mask centered
% at its centroid
